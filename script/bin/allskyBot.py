...
def call_heater(option):
    hdl = subprocess.Popen("/home/pi/bin/allskyheating.sh " + option, shell=True, stdout=subprocess.PIPE).stdout
    res = hdl.read()
    return res
...
def main():
    ...
    bot.sendMessage(chat_id, emoji.emojize(":rocket: Hello, I\'m online.", use_aliases=True))
