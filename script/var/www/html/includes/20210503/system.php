...
function DisplaySystem()
{
    ...
    // heating
    $heating = exec("tail -1 /home/pi/log/$(date +\%Y\%m\%d)_tempGuard.log | awk -F '->' '{print $2}'");			 
    ?>
    <div class="row">
        <div class="col-lg-12">
		    ...
		    if (isset($_POST['service_stop'])) {
				    ...
				    <div class="info-item">SD Card</div>
									...
									<div class="info-item">Dome Temperature</div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-<?php echo $envtemperature_status ?> progress-bar-striped active"
                                             role="progressbar"
                                             aria-valuenow="<?php echo $envtemperature ?>" aria-valuemin="0"
                                             aria-valuemax="100"
                                             style="width: <?php echo $envtemperature ?>%;"><?php echo $envtemperature ?>&deg;C
                                        </div>
                                    </div>
                                    <div class="info-item">Heating</div>
                                    <?php echo $heating ?></br>
                                </div><!-- /.panel-body -->
                            </div><!-- /.panel-default -->
                        </div><!-- /.col-md-6 -->
